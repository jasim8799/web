...
class EcommerceDevelopment extends StatefulWidget {
  const EcommerceDevelopment({Key? key}) : super(key: key);

  @override
  State<EcommerceDevelopment> createState() => _EcommerceDevelopmentState();
}

class _EcommerceDevelopmentState extends State<EcommerceDevelopment> {
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    "As one of the top e-commerce development companies,Netcoreinfo Business Services keeps you up-to-date with the latest e-commerce development solutions.Expand your business at your conveniece by providing a great experiance for your customers with our experienced professionals.Make your business break through the market by incorporating the technological advancements essential for your growth.",
                                    style: TextStyle(
                                        fontSize: 17,
