...
class comanymore extends StatefulWidget {
  const comanymore({Key? key}) : super(key: key);

  @override
  State<comanymore> createState() => _comanymoreState();
}

class _comanymoreState extends State<comanymore> {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding:
                                            const EdgeInsets.only(right: 750),
                                        child: Text(
                                          "WHY US?",
                                          style: TextStyle(
                                              fontSize: 25,
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          "Our philosophy is to build a long-term business partnership with our clients wehere interpersonal relationships,reliability,assure quality,and target-oriented modern technology are the major building blocks.",
                                          style: TextStyle(
                                              fontSize: 17,
                                              fontWeight: FontWeight.w500),
                                          textAlign: TextAlign.left,
