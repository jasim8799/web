...
import 'package:netcoreinfoproject/pages/hovereffer.dart';
                ...
                child: Column(children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                        color: Color.fromARGB(55, 30, 164, 173)),
                    child: Row(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                            ...
                            left: 80,
                            child: Text(
                              "Netcoreinfo provides a one-step automated solution for your",
                              style: TextStyle(
                                  fontSize: 20,
                        ...
                        Positioned(
                            ...
                            left: 80,
                            child: Text(
                                "trade and industry.We provide the optimum and customized solutions",
                                style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.w300,
                                    color: Colors.white))),
                        Positioned(
                            ...
                            left: 80,
                            child: Text(
                                "for your organisation.We create customized solutions are provide different",
                                style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.w300,
                                    color: Colors.white))),
                        Positioned(
                            ...
                            left: 80,
                            child: Text(
                              "products and services according to the size and field of your organisation.",
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w300,
                                  color: Colors.white),
                        ...
                        Positioned(
                            ...
                            left: 80,
                            child: Text(
                              "We help you maintain competitiveness and achive your business objectives",
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w300,
                                  color: Colors.white),
                        ...
                        Positioned(
                            ...
                            left: 80,
                            child: Text(
                              "by providing customized solutions that meet your specifices.",
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w300,
                                  color: Colors.white),
