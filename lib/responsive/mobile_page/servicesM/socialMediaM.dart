...
class SocialMedialM extends StatefulWidget {
  const SocialMedialM({super.key});

  @override
  State<SocialMedialM> createState() => _SocialMedialMState();
}

class _SocialMedialMState extends State<SocialMedialM> {
  @override
          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("assets/images/j23.png"),
                        fit: BoxFit.cover)),
              ),
              SizedBox(
                height: 15,
                  ...
                  child: Column(
                    children: [
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                width: 220,
                                child: Text(
                                  "Services for social media marketing have many benefits for both new and existing brands. Social media content marketing may promote brand loyalty, search traffic, SEO, and customer engagement with the correct social media marketing strategy and campaign monitoring system. ",
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          "NetcoreInfo helps small businesses, large corporations, and companies to benefit through social media marketing as a powerful tool for increasing customer acquisition, brand recognition, and website traffic.",
                          textAlign: TextAlign.justify,
                        ),
                      ),
                    ],
