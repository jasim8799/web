...
class optimationM extends StatefulWidget {
  const optimationM({Key? key}) : super(key: key);

  @override
  State<optimationM> createState() => _optimationMState();
}

class _optimationMState extends State<optimationM> {
  @override
          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("assets/images/w14.jpeg"),
                        fit: BoxFit.cover)),
              ),
              SizedBox(
                height: 15,
