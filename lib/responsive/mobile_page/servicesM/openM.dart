...
class openM extends StatefulWidget {
  const openM({Key? key}) : super(key: key);

  @override
  State<openM> createState() => _openMState();
}

class _openMState extends State<openM> {
  @override
                  ...
                  child: Container(
                    ...
                    child: Column(children: [
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                height: 125,
                                child: Text(
                                  "Open source software typically offers more freedom and extensibility that what is offered by commercial software which makes it the best option for you and your business .Connect with the best open source software development company in Noida,proficient in open source",
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          "technology,to rapidly incease rich software functions,drive operational helfuiness and get rid of cost connected with proprietary software.Open source consulting services offer cost efficient and innovative resolution to resolve complex business issue.Netcoreinfo Business Services simply incensed Centre of experts team with specialties open source technology advisor and technology professionals convey customizable and progressive Open Source Development Services to go with user's individual business requirements.",
                          textAlign: TextAlign.justify,
                        ),
                      ),
                      Padding(
