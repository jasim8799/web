...
class ppcM extends StatefulWidget {
  const ppcM({super.key});

  @override
  State<ppcM> createState() => _ppcMState();
}

class _ppcMState extends State<ppcM> {
  @override
                  ...
                  child: Column(
                    children: [
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                width: 220,
                                child: Text(
                                  "Pay-per-click (PPC) advertising is one of the most effective ways to reach your audience. PPC services help you meet your objectives while also measuring and optimising your PPC ROI. It enables you to reach them where they are already looking and gain an advantage over competition. We know the exact ",
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          "way for creating a successful and winning PPC campaign. With our Pay Per Click services, you can put an end to your search for continuous and controllable traffic, optimise the performance of your ad campaigns, and increase your ROIs.",
                          textAlign: TextAlign.justify,
                        ),
                      ),
                    ],
