...
import 'package:netcoreinfoproject/responsive/mobile_page/servicesM/companyMmore.dart';
import 'package:read_more_text/read_more_text.dart';
import 'package:url_launcher/link.dart';

class CompanyM extends StatefulWidget {
  const CompanyM({Key? key}) : super(key: key);

  @override
  State<CompanyM> createState() => _CompanyMState();
}

class _CompanyMState extends State<CompanyM> {
